...
<form id="form" action="findPw.do" method="post" onsubmit="return call();">
	...
	<div class="fp_txt">새 비밀번호</div><input id="u_pw" type="password" class="fp_input" name="u_pw"><br>
	<div class="fp_txt">새 비밀번호 확인</div><input type="password" id="u_pwCheck" class="fp_input"><br>
