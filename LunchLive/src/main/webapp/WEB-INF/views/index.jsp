...
>>>>>>> 4220ac2d0c96e93e40109ee6cdd67567210157ed
            </div>
        </header>
        <!-- main 페이지 -->
        ...
        <ul>
            ...
            <li class="faq_answer">
                ...
                <span class="faq_txt">✔런치라이브는 회원탈퇴된 유저정보를 보관하고 있지 않습니다. 
                    회원 탈퇴된 순간과 동시에 유저정보는 삭제 됩니다.
                </span>
            </li>
            ...
            <li class="faq_answer">
                ...
                <span class="faq_txt">✔런치라이브에서는 커뮤니티페이지에서 버그제보에대해서 작성하시면
                    런치라이브 관리자가 확인 후 담당자에게 전달됩니다.(최대 1달 소요)
                </span>
            </li>
            ...
            <li class="faq_answer">
                ...
                <span class="faq_txt">✔런치라이브에서는 유저분들의 회원정보를 절대로 상업적으로 이용하지 않습니다.                    
                </span>
            </li>
        
            <li class="faq_question"> <span class="faq_txt">❔부적절한 게시물을 발견하였습니다.</span></li>
        
            <li class="faq_answer"><span class="faq_txt">✔부적절한 게시물(자극적이며 성적인 컨텐츠, 폭력적인 게시물, 종교적인 내용을 지닌 게시물, 남을 비하하는 게시물 등)은 신속히 제거할려고 조치하고 있습니다. 
                혹시라도 대처가 늦게 되어, 유저 여러분들에게 불쾌감을 드린 점은 사과드립니다.
            </span></li>
        
            <li class="faq_question"><span class="faq_txt">❔런치라이브에서 제공하는 서비스에 대해서 궁금합니다.</span> </li>
        
            <li class="faq_answer"> <span class="faq_txt">✔런치라이브는 직장인, 학생분들과 같이 점심 메뉴를 고르기 힘들어 하는 분들을 위해서
                점심메뉴를 편하게 결정하기 위한 서비스를 제공하고 있습니다. 먼저, 가게명을 알고 계실 경우 가게 위치를 찾을 수 있는
                지도 기능을 제공해 드리고 있습니다. 또한, 점심메뉴의 결정을 돕기위한 여러 게임들 또한 서비스의 일부 입니다. 마지막으로, 회원이신
                유저 여러분의 의견을 수렴 받기 위하여 커뮤니티 기능을 제공하고 있습니다.
            </span> </li>
        
            <li class="faq_question"> <span class="faq_txt">❔회원 복구에 관하여 궁금합니다.</span> </li>
        
            <li class="faq_answer"> <span class="faq_txt">✔런치라이브에서는 절대로 회원 탈퇴한 유저 여러분들의 정보를 보관하고 있지 않습니다.
                따라서, 회원 탈퇴후에는 이전과 동일한 닉네임과 아이디로 재가입 하시는 것 외에는 어떠한 경우에도 
